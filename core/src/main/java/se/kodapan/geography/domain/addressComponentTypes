...
/**
 * for flyweight reasons this is not a string as in the google api.
 *
 * @author kalle
 * @since 2010-jun-24 15:57:02
 */
public enum AddressComponentType implements Serializable {
  ...
  // todo these undocumented types have been found:
